<template>
  <div class="login">
    <!-- Modal -->
        <div class="modal fade text-left" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                        ...
                        <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" @keyup.enter="loginUser" v-model="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                            </div>
                        ...
                        <div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" @keyup.enter="registerUser" v-model="password" class="form-control" id="password" placeholder="Password">
                            </div>
